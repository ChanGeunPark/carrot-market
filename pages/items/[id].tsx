  ...
  return (
    ...
    <div className='px-4 py-10'>
      <div className='mb-8'>
        ...
        <div className='flex cursor-pointer items-center border-5 border-b space-x-3 py-3'>
        ...
        <div className='mt-5'>
          ...
          <div className='flex items-center justify-between space-x-2'>
            <button className='flex-1 bg-orange-500 text-white py-3 rounded-md focus:ring-2 focus:ring-offset-2 font-medium focus:ring-orange-600 hover:bg-orange-600'>Talk to seller</button>
        ...
        <div className='mt-6 grid grid-cols-2 gap-4'>
          {[1, 2, 3, 4, 5, 6].map((_, i) => (
            <div key={i}>
              ...
              <h3 className='text-zinc-700 -mb-1'>Galaxy S60</h3>
