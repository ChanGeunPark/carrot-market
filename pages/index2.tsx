...
function Index2(){
    ...
    return(
        <div className="bg-slate-400 xl:place-content-center py-20 px-5 sm:px-20 grid gap-10 md:grid-cols-2 lg:grid-cols-3 min-h-screen">
      <div className="bg-white dark:bg-black dark:text-white p-6 rounded-2xl shadow-xl flex flex-col justify-between">
      ...
      <div className="bg-white overflow-hidden rounded-2xl shadow-xl group">
        <div className="bg-blue-500 portrait:bg-indigo-600 landscape:bg-yellow-500 p-6 pb-14 lg:pb-52">
      ...
      <div className='flex flex-col space-y-2 p-5'>
            {/* <details className='select-none open:text-white open:bg-indigo-600'>
            ...
            <input type="file" className='box-border file:hover:text-purple-500 file:hover:bg-white file:hover:border file:hover:border-purple-500 file:cursor-pointer file:transition-color file:border-0 file:rounded-xl file:bg-purple-600 file:px-5 file:text-white' />
            <p className='first-letter:text-7xl first-letter:hover:text-purple-300'>Hellow everybody!</p>
        </div>
    </div>
    );
}
